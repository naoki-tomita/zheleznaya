...
},{"./Settable":"node_modules/zheleznaya/dist/Settable.js","./Equals":"node_modules/zheleznaya/dist/Equals.js"}],"node_modules/marked/lib/marked.js":[function(require,module,exports) {
var define;
...
},{}],"src/Router.tsx":[function(require,module,exports) {
"use strict";
...
function emit() {
  cbs.forEach(function (it) {
    return it(location.hash.replace("#", ""));
  });
}
...
exports.Link = function (_a, children) {
  var href = _a.href;
  return zheleznaya_1.h("a", {
    style: {
      color: "inherit",
      textDecoration: "none"
    },
...
},{"zheleznaya":"node_modules/zheleznaya/dist/index.js"}],"src/Store.ts":[function(require,module,exports) {
"use strict";
...
exports.store = zheleznaya_1.createStore({
  path: location.href.replace("#", ""),
  html: ""
});
Router_1.onRouteChange(href);
fetchMarkdown(exports.store.path + ".md");

function href(path) {
  exports.store.path = path;
  fetchMarkdown(path + ".md");
}

exports.href = href;

function markedAsync(md) {
  return __awaiter(this, void 0, Promise, function () {
    return __generator(this, function (_a) {
      return [2
      /*return*/
      , new Promise(function (ok) {
        return marked_1.default(md, function (_, d) {
          return ok(d);
        });
      })];
    });
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          return [4
          /*yield*/
          , fetch("../articles/" + path).then(function (it) {
...
},{"marked":"node_modules/marked/lib/marked.js","zheleznaya":"node_modules/zheleznaya/dist/index.js","./Router":"src/Router.tsx"}],"src/components/Content.tsx":[function(require,module,exports) {
"use strict";
...
exports.Content = function (_, children) {
  return zheleznaya_1.h("main", null, children);
};
},{"zheleznaya":"node_modules/zheleznaya/dist/index.js"}],"src/components/Footer.tsx":[function(require,module,exports) {
"use strict";
...
exports.Footer = function () {
  return zheleznaya_1.h("footer", null, zheleznaya_1.h("p", null, "Created by ", zheleznaya_1.h("a", {
    href: "https://github.com/naoki-tomita"
  }, "Kojiro Ueda")), zheleznaya_1.h("p", null, "Inspired by React"));
};
},{"zheleznaya":"node_modules/zheleznaya/dist/index.js"}],"src/components/Header.tsx":[function(require,module,exports) {
"use strict";
...
exports.Header = function () {
  return zheleznaya_1.h("header", null, zheleznaya_1.h("h1", null, zheleznaya_1.h(Router_1.Link, {
    href: "/"
  }, "Zheleznaya")), zheleznaya_1.h("small", null, zheleznaya_1.h("code", null, zheleznaya_1.h("a", {
    href: "https://github.com/naoki-tomita/zheleznaya"
  }, "Github"))));
};
},{"zheleznaya":"node_modules/zheleznaya/dist/index.js","../Router":"src/Router.tsx"}],"src/components/Html.tsx":[function(require,module,exports) {
"use strict";
...
exports.Html = function (_a) {
  var html = _a.html;
  return zheleznaya_1.h("div", {
    ref: function ref(el) {
      return el.innerHTML = html;
    }
  });
};
},{"zheleznaya":"node_modules/zheleznaya/dist/index.js"}],"src/components/App.tsx":[function(require,module,exports) {
"use strict";
...
exports.App = function () {
  return zheleznaya_1.h("div", null, zheleznaya_1.h(Header_1.Header, null), zheleznaya_1.h(Content_1.Content, null, zheleznaya_1.h(Html_1.Html, {
    html: Store_1.store.html
  })), zheleznaya_1.h(Footer_1.Footer, null));
};
},{"zheleznaya":"node_modules/zheleznaya/dist/index.js","../Store":"src/Store.ts","./Content":"src/components/Content.tsx","./Footer":"src/components/Footer.tsx","./Header":"src/components/Header.tsx","./Html":"src/components/Html.tsx"}],"index.tsx":[function(require,module,exports) {
"use strict";
...
zheleznaya_1.render(zheleznaya_1.h(App_1.App, null));
},{"zheleznaya":"node_modules/zheleznaya/dist/index.js","./src/components/App":"src/components/App.tsx"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/dist/docs.f69400ca.js.map