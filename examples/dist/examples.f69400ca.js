...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/zheleznaya/index.ts":[function(require,module,exports) {
"use strict";
...
function h(element, attributes) {
    var children = [];
    for (var _i = 2; _i < arguments.length; _i++) {
        children[_i - 2] = arguments[_i];
    }
    return typeof element === "string"
        ? { name: element, attributes: attributes || {}, children: children }
...
function createElement(_a) {
    ...
    var el = Object.keys(attributes || {}).reduce(function (el, key) {
    ...
    (children || []).forEach(function (it) { return el.append(typeof it === "string" ? it : createElement(it)); });
    return el;
}
function render(el) {
    var vNodes = el({}, []);
...
var App = function App() {
  return zheleznaya_1.h("div", {
    class: "my-class"
  }, zheleznaya_1.h("input", {
    checked: true
  }), zheleznaya_1.h("div", {
    onclick: function onclick(e) {
      return console.log(e);
    }
  }, "fuga"), zheleznaya_1.h("div", null, "poyo"), zheleznaya_1.h(MyComponent, {
    key: "hello"
  }));
};

zheleznaya_1.render(App);
},{"zheleznaya":"node_modules/zheleznaya/index.ts"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/examples.f69400ca.js.map